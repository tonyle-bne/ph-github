...
rem               Modified to include org_unit_codes starting with P
rem   Change    : E Wood
rem   Date      : 02 Nov 2006
rem               Added criteria in SQL to prevent export of area that have display_ind
rem               set to 'N'
rem   Change    : E Wood
rem   Date      : 15 Nov 2006
rem               Fixed alias for subgroup_codes when referencing the attribute 
rem               display_ind. 
rem   Change    : Tony Le 
rem             : 22 Sept 2009
rem               SAMS upgrade
...
set heading off
set TRIMSPOOL ON
spool $DATA/ph_export3.lis

select to_char(nvl(c2.sort_order,0),'000') ||'|'||
